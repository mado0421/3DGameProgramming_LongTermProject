...
void GameScene::Render(D3D12_CPU_DESCRIPTOR_HANDLE hBckBufRtv, D3D12_CPU_DESCRIPTOR_HANDLE hBckBufDsv)
{	
	/*========================================================================
...
ID3D12RootSignature* GameScene::CreateRootSignature()
{
...
void GameScene::CreateDescriptorHeap() 
{
...
void GameScene::CreatePassInfoShaderResource()
{
...
void GameScene::UpdatePassInfoAboutCamera()
{
	CameraComponent* cam = m_pCameraObject->FindComponent<CameraComponent>();
...
Object* GameScene::FindObjectByName(const char* strName)
{
