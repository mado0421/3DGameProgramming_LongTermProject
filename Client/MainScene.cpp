...
void MainScene::Init(Framework* pFramework, ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	/*========================================================================
	* 주요 변수 초기화
	*=======================================================================*/
...
void MainScene::Update(float fTimeElapsed)
{
...
void MainScene::Render(D3D12_CPU_DESCRIPTOR_HANDLE hBckBufRtv, D3D12_CPU_DESCRIPTOR_HANDLE hBckBufDsv)
{
	/*========================================================================
...
ID3D12RootSignature* MainScene::CreateRootSignature()
{
...
void MainScene::CreateDescriptorHeap()
{
...
void MainScene::CreatePassInfoShaderResource()
{
...
void MainScene::UpdatePassInfoAboutCamera()
{
	CameraComponent* cam = m_pCameraObject->FindComponent<CameraComponent>();
...
Object* MainScene::FindObjectByName(const char* strName)
{
...
void MainScene::LoadLevelEnvironment()
{
...
void MainScene::CreateEnvObject(const char* strModelName, const char* strMaterialName, XMFLOAT3 pos, XMFLOAT4 rot)
{
...
void MainScene::CreateEnvObject(MY_ENV_OBJECT_DATA objData)
{
	CreateEnvObject(objData.strMeshName.c_str(), objData.strMatName.c_str(), objData.xmf3Position, objData.xmf4Rotation);
}

void MainScene::CreateCollider(MY_COLLIDER_OBJECT_DATA colData)
{
...
void MainScene::CreateTargetBoard(const char* strName,
