...
PipelineStateObject::PipelineStateObject(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dRootSignature)
{
...
DebugWindowPSO::DebugWindowPSO(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dRootSignature)
{
	m_pd3dPipelineState = NULL;
	ID3DBlob* pd3dVertexShaderBlob = NULL, * pd3dPixelShaderBlob = NULL;
...
DepthDebugPSO::DepthDebugPSO(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dRootSignature)
{
	m_pd3dPipelineState = NULL;
	ID3DBlob* pd3dVertexShaderBlob = NULL, * pd3dPixelShaderBlob = NULL;
...
Pass2PSO::Pass2PSO(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dRootSignature)
{
	m_pd3dPipelineState = NULL;
	ID3DBlob* pd3dVertexShaderBlob = NULL, * pd3dPixelShaderBlob = NULL;
...
ShadowPSO::ShadowPSO(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dRootSignature)
{
	m_pd3dPipelineState = NULL;
	ID3DBlob* pd3dVertexShaderBlob = NULL, * pd3dPixelShaderBlob = NULL;
